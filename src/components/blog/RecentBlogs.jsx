  ...
  return (
    <div className="mt-10 md:mt-[100px] px-4 md:px-0">
          ...
          {mockBlogs.map((blog) => (
            <div key={blog.id} className="mb-4">
              ...
              <div className="flex flex-col justify-start gap-4 md:gap-8">
                ...
                <p
                  className="underline text-layover-blue font-bold font-montserrat cursor-pointer"
      ...
      <div className="flex items-center justify-center mt-[100px]">
        <button className="border-[1px] border-layover-blue hover:bg-blue-50 text-layover-blue rounded-md  py-2 px-8">
          Load More
        </button>
      </div>
    </div>
